...
Но вреден север для меня
    ...
    fun calcPrimesNumber(calcPrimesNumber: (Int) -> Int) {
        ...
        assertEquals(12, calcPrimesNumber(40))
        assertEquals(15, calcPrimesNumber(50))
        assertEquals(17, calcPrimesNumber(60))
        assertEquals(19, calcPrimesNumber(70))
        assertEquals(22, calcPrimesNumber(80))
        assertEquals(24, calcPrimesNumber(90))
        assertEquals(25, calcPrimesNumber(100))
        assertEquals(95, calcPrimesNumber(500))
        assertEquals(168, calcPrimesNumber(1000))
        assertEquals(171, calcPrimesNumber(1020))
        assertEquals(3569, calcPrimesNumber(33333))
        assertEquals(384326, calcPrimesNumber(5555555))
